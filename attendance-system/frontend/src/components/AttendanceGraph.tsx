              ...
              return (
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between font-bold text-base pt-2 border-t">
                    <span>Overall %:</span>
                    <span className={overallPercent >= 75 ? "text-accent" : "text-danger"}>{overallPercent}%</span>
                  </div>
                </div>
              );
            })()}
              ...
              {courses.map((course, idx) => {
                ...
                return (
                  <tr key={idx} className="border-t hover:bg-slate-50">
                    ...
                    <td className="px-3 py-2 text-right text-accent font-semibold">{course.presentClasses}</td>
                    <td className="px-3 py-2 text-right text-danger font-semibold">{absent}</td>
                    <td className="px-3 py-2 text-right">{course.totalClasses}</td>
                    <td className={`px-3 py-2 text-right font-semibold ${course.percentage >= 75 ? "text-accent" : "text-danger"}`}>
